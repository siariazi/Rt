...
params:
  logfile: "/Users/siavashriazi/Desktop/SFU/Rt/Rt codes/Chris/data/siavash-actualScens/Scen01B_keep70/1B_keep70.log"
  gridsize: 110
...
```{r plot-Re}
    ...
    write.csv(Re_gridded_hpd, file = "scen01B_keep70percent.csv" , row.names = TRUE)
```
